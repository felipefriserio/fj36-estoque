...
public class EstoqueService  extends UnicastRemoteObject implements EstoqueRmi {
	...
	public EstoqueService() throws RemoteException {
		...
		repositorio.put("SOA", new ItemEstoque("TDD", 3));
		repositorio.put("SOA", new ItemEstoque("RES", 4));
		repositorio.put("SOA", new ItemEstoque("LOG", 3));
		repositorio.put("SOA", new ItemEstoque("WEB", 4));
	}
